...
public class TheApplet extends Applet {
    ...
    */
    ...
    cipher.doFinal( buffer, (short)5, (short)buffer[4], buffer, (short)buffer[5] );
    // apdu.setOutgoingAndSend( case data, case offset )
		apdu.setOutgoingAndSend( (byte)buffer[5], buffer[4] );
	}
